...
public class AdminController {
	...
	public ResponseEntity<Department> removeDepartment(@PathVariable int departmentId) {
		Department d = adminService.removeDepartment(departmentId);
	...
	public ResponseEntity<Operator> removeOperator(@PathVariable int operatorId) {
		Operator o = adminService.removeOperator(operatorId);
